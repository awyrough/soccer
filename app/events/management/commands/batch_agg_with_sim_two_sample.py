...
# sample code: 
#	python manage.py batch_agg_with_sim_two_sample.py --null_hypo_iterations=5 --max_simulated_incr=10 --print_to_csv
			...
			for key, value in other_info.iteritems():
				for moment_team in moment_teams:
					for min_tw in min_tws:
						results.append(aggregate_vs_simulate_two_sample(sw_id, moment, moment_team, value[0], \
